function attachListeners() {
    ...
    function onConvertClick(ev) {
        ...
        const timeInSeconds = convert(Number(input.value), input.id);
        
        daysElement.value = timeInSeconds.days;
        hoursElement.value = timeInSeconds.hours;
        minutesElement.value = timeInSeconds.minutes;
        secondsElement.value = timeInSeconds.seconds;
    }
